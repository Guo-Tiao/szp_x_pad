...
void ui_app_uart_setup(lv_obj_t* parent)
{
    ...
    lv_obj_set_size(lv_uart_log_obj, 260, 170); // 设置父对象大小
    ...
    lv_obj_set_size(lv_uart_send_txt, 200, 40);
    ...
    lv_obj_set_size(lv_uart_send_btn, 55, 35);
    ...
    //开启线程
    xTaskCreate(task_ui_app_uart_recv_data, "tk_ui_uart_recv_data", 2048, NULL, 10, task_ui_app_uart_recv_handle);
}